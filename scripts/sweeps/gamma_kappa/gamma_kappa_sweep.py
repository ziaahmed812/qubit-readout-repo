#!/usr/bin/env python3
"""
Legacy filename preserved: this script sweeps kappa and epsilon, despite the historical
gamma-kappa naming used in the original thesis artifact path.
...
Usage:
    python gamma_kappa_sweep.py --kappa 0.05 --epsilon 0.05 --output_dir results/
"""
...
def run_simulation(kappa_val, epsilon_val, output_dir):
    ...
    """
    print("="*60)
    print("  LEGACY-NAMED KAPPA-EPSILON GRID SWEEP")
    print("="*60)
    ...
    filename = f"gamma_kappa_sweep_kappa{kappa_val:.6f}_eps{epsilon_val:.6f}.npz"
