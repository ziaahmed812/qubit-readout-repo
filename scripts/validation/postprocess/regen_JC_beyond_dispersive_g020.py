#!/usr/bin/env python3
"""
Regenerate JC_H_BEYOND-dispersive-with-gamma_g0.20_SNR.pdf with 1.5x larger fonts, no title.
"""
import numpy as np
...
plt.savefig(OUTPUT_DIR / "JC_H_BEYOND-dispersive-with-gamma_g0.20_SNR.pdf", format='pdf', bbox_inches='tight', dpi=300)
plt.close()
print("Saved JC_H_BEYOND-dispersive-with-gamma_g0.20_SNR.pdf")
